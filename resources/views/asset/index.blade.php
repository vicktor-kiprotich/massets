...
@section('content')
            ...
            <div class="row pt-3">
                ...
                <div class="col-md-6 text-md-right pb-md-0 pb-3">
                    ...
                    <button type="button" data-toggle="modal" data-target="#import"
                        class="btn btn-sm btn-fill btn-primary"><i class="fa fa-plus"></i> <?php echo trans('lang.import_assets'); ?></button>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body ">
                            ...
                            {{-- messageimport --}}
                            <div id="messageimport" class="display-none alert alert-success"><?php echo trans('lang.data_imported'); ?></div>
        ...
        <div id="import" class="modal fade " role="dialog">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <form action="#" id="formimport" enctype="multipart/form-data" autocomplete="off">
                        <div class="modal-header">
                            <h5 class="modal-title"><?php echo trans('lang.import_assets'); ?></h5>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">
                            <div id="formimportmsg" class="display-none alert alert-success"><?php echo trans('lang.data_imported'); ?></div>

                            <div class="drag-and-drop-area" id="drag-and-drop-area" ondrop="handleDrop(event)"
                                ondragover="handleDragOver(event)" ondragleave="handleDragLeave(event)">
                                <p id="drag-and-drop-text"><?php echo trans('lang.drag_or_click_to_upload'); ?></p>
                        ...
                        <div class="modal-body">
                                ...
                                <div class="form-group col-md-6 mb-0">
                                    ...
                                    <div class="input-group mb-0">
                                        <input class="form-control setdate" required=""
                                            placeholder="<?php echo trans('lang.purchasedate'); ?>" id="purchasedate" name="purchasedate"
                                            type="text">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 mb-0">
                                    ...
                                    <div class="input-group mb-0">
                                        <input class="form-control number" required=""
                                            placeholder="<?php echo trans('lang.warranty'); ?>" id="warranty" name="warranty"
                                            type="text">
                    ...
                    <form action="#" id="formedit" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label><?php echo trans('lang.assettag'); ?></label>
                                    <input name="assettag" type="text" id="editassettag" class=" form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label><?php echo trans('lang.serial'); ?></label>
                                    <input name="serial" type="text" id="editserial" class="form-control " required
                                        placeholder="<?php echo trans('lang.serial'); ?>" />
                                </div>
                                <div class="form-group col-md-6">
                                    <label><?php echo trans('lang.assettype'); ?></label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 mb-0">
                                    ...
                                    <div class="input-group mb-0">
                                        <input class="form-control setdate" required=""
                                            placeholder="<?php echo trans('lang.purchasedate'); ?>" id="editpurchasedate" name="purchasedate"
                                            type="text">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 mb-0">
                                    ...
                                    <div class="input-group mb-0">
                                        <input class="form-control number" required=""
                                            placeholder="<?php echo trans('lang.warranty'); ?>" id="editwarranty" name="warranty"
                                            type="text">
                                        <span class="input-group-addon border-1"
                                            id="editwarrantyyear"><?php echo trans('lang.month'); ?></span>
                                    </div>
                                    <label class="error" for="warranty"></label>
                                </div>
                                <div class="form-group col-md-6 mb-0">
                    ...
                    <form action="#" id="formcheckout" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label><?php echo trans('lang.assettag'); ?></label>
                                    <input name="assettag" type="text" readonly id="checkoutassettag"
                                        class=" form-control" required placeholder="<?php echo trans('lang.assettag'); ?>" />
                                </div>
                                <div class="form-group col-md-12">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12 mb-0">
                                    ...
                                    <div class="input-group mb-0">
                                        <input class="form-control setdate" required=""
                                            placeholder="<?php echo trans('lang.checkoutdate'); ?>" id="checkoutdate" name="checkoutdate"
                                            type="text">
                                        <span class="input-group-addon border-1" id="date"><i
                                                class="fa fa-calendar"></i></span>
                                    </div>
                    ...
                    <form action="#" id="formcheckin" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label><?php echo trans('lang.assettag'); ?></label>
                                    <input name="assettag" type="text" readonly id="checkinassettag"
                                        class=" form-control" required placeholder="<?php echo trans('lang.assettag'); ?>" />
                                </div>
                                <div class="form-group col-md-12">
                                    <label><?php echo trans('lang.asset'); ?></label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12 mb-0">
                                    ...
                                    <div class="input-group mb-0">
                                        <input class="form-control setdate" required=""
                                            placeholder="<?php echo trans('lang.checkindate'); ?>" id="checkindate" name="checkindate"
                                            type="text">
                                        <span class="input-group-addon border-1" id="date"><i
                                                class="fa fa-calendar"></i></span>
                                    </div>
    ...
    <script>
        ...
        function handleDragOver(event) {
            ...
            dragAndDropText.textContent = "<?php echo trans('lang.drop_file_here'); ?>";
        }

        // Handle drag leave event
        function handleDragLeave(event) {
            dragAndDropArea.classList.remove('drag-over');
            dragAndDropText.textContent = "<?php echo trans('lang.drag_or_click_to_upload'); ?>";
        }
        ...
        function handleDrop(event) {
            ...
            if (files.length > 0) {
                ...
                updateFileName(files[0].name); // Update file name display
            }
        }

        // Update drag-and-drop area text when a file is selected via the input
        fileInput.addEventListener('change', () => {
            if (fileInput.files.length > 0) {
                updateFileName(fileInput.files[0].name); // Update file name display
            }
        });

        // Function to update the file name in the drag-and-drop area
        function updateFileName(fileName) {
            dragAndDropText.textContent = "<?php echo trans('lang.file_selected'); ?>: " + fileName;
        }
    </script>
